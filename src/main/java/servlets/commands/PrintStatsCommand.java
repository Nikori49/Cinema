...
public class PrintStatsCommand implements Command {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Showtime> showtimeList = DBManager.getInstance().getShowtimesForMonth(Date.valueOf(stringDate));
        ...
        document.save("C:\\Users\\yohoh\\Desktop\\JAVA\\Cinema\\src\\main\\webapp\\PDFReports\\" + fileName + "report.pdf");
        document.close();
        return "manager.jsp";
    }
}
