...
public class ShowtimePage extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Film film = DBManager.getInstance().getFilm(showtime.getFilmId());
        ...
        for (String s:seatList) {
            ...
            out.write(" data-placement=\"top\" data-toggle=\"popover\" data-trigger=\"hover\" data-content=\""+s+"\" value=\""+s+"\" name=\""+s+"\" type=\"checkbox\"></td>\n");
            if (counter==24){
                out.write("</tr><tr>");
                counter=0;
            }
        ...
        out.write("            </tr>\n" +
                "        </table>\n");
        if (Objects.equals(userRole, "client")){
            out.write("<input class=\"btn btn-success\" type=\"submit\" value=\""+resourceBundle.getString("label.purchaseTickets")+"\">");
        }
        out.write("    </form>\n" +
                "</div>");
